...
"#{{{ TEST function
command -nargs=0 QUESTION :call Quest()
function Quest()
	let g:fold1 = input('Enter tput cup [question]: ')
	let g:fold2 = input('Enter question: ')
	execute "normal! itput cup ".g:fold1." 0 \r"
	execute "normal! iecho -e '"g:fold2."'\r"
	execute "normal! itput cup 20 0\r"
	execute "normal! iyesno\r"
	execute "normal! iif [[ $YESNO == 0 ]];\r"
	execute "normal! ithen\r"
	execute "normal! iaa".g:fold1."='0'\r"
	execute "normal! itput cup ".g:fold1." 40 \r"
	execute "normal! iecho -e '\\033[44m\\033[37mYES\\033[0m'\r"
	execute "normal! ielse\r"
	execute "normal! iaa".g:fold1."='1'\r"
	execute "normal! itput cup ".g:fold1." 40\r"
	execute "normal! iecho -e '\\033[44m\\033[37mNO\\033[0m'\r"
	execute "normal! ifi"
endfunction
...
function DpkgCHK()
	...
	execute 'normal! iDEPS_'.g:package1.'=\"'.g:package2.'\"'
	execute "normal! i\rfor $pack in ${DEPS_".g:package1."[@]}; do"
	execute "normal! i\rdpgk -s $pack >/dev/null 2>&1 \r"
	execute "normal! iif [[ $? == 1 ]]; then\r"
	execute 'normal! iecho -e \"\033[33mInstalling \033[31m${pack}\033[33m...\033[0m\"'
	execute "normal! i\rsudo apt install $pack -y >/dev/null 2>&1\r"
